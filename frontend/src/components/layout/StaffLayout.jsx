...
import { Milk, LayoutDashboard, LogOut, Menu, X, History } from 'lucide-react';
...
export default function StaffLayout() {
  ...
  const NAV = [
    ...
    { to: '/staff/milk',    icon: Milk,            label: 'Milk Entry', end: true },
    { to: '/staff/history', icon: History,         label: 'History',    end: true },
  ];
